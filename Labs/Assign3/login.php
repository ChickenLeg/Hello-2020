...
$fullname = $emailid = $contactno = $billingaddress = $shippingaddress = $password = $confirmpassword = "";
...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO users (name, email, contactNo, password,shippingAddress, billingAddress, regDate) 
  			  VALUES('$fullname', '$emailid', '$contactno' , '$password', '$shippingaddress', '$billingaddress', '$timeStamp')";
